export default {
  siteMetadata: {
    ...
    description: "Grasp the art of investing by understanding the maths, automation, artificial inteligence and psychology behind! This blog doesn't provide financial advices or consulting on investing. It is just a try to simplify, by braking it down, investing and make it more accessible primarily to software enthusiasts and furhter to anyone else passionate about the topic.",
